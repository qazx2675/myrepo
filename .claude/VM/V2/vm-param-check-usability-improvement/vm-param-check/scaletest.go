...
func runScale(n int, out, user string, onlyFail, noColor bool) {
	...
	shares := checker.SharesExpect{EV01: checker.RatioShares(scaleExpectShares), Groups: map[string][]checker.SharesItem{"ev02": checker.RatioShares(scaleExpectShares), "ev03": checker.RatioShares(scaleExpectShares)}}
