...
echo "  8) ./change.sh <계정>"
echo
echo "참고: 이 관리서버가 RHEL/CentOS 6 이면 bin_os6/ 에 Go 1.20 으로 미리"
echo "      빌드해 둔 ip-change-engine/ldap-config-engine/nm-* 가 있습니다"
echo "      (integration.conf 의 os6_hostgroup 에 이 서버 hostname 을 채우면"
echo "      자동으로 쓰입니다, README 3.4 참고)."
