...
- 경로: `.claude/vm-param-setting-check/fail-based-param-fix/` (요청하신 대로, 체크 도구 하위) — 이후 `.claude/VM 업무/vm-param-setting-check/fail-based-param-fix/`로 한 번 더 정리됨
