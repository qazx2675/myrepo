...
func main() {
	...
	affinityFile01 := flag.String("affinityFile01", "", "ev01 affinity 설정 파일 (미지정 시 -ht로 1:1 자동계산, 지정 시 파일 내용이 -ht보다 우선)")
	affinityFile02 := flag.String("affinityFile02", "", "ev02 affinity 설정 파일 (미지정 시 -ht로 1:1 자동계산, 지정 시 파일 내용이 -ht보다 우선)")
	affinityFile03 := flag.String("affinityFile03", "", "ev03 affinity 설정 파일 (미지정 시 -ht로 1:1 자동계산, 지정 시 파일 내용이 -ht보다 우선)")
