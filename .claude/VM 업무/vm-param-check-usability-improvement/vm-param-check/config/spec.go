...
//
// 현업에서는 VM 스펙별로 폴더명이 이미 규칙화되어 있어서(예: RND-CAE001-LICE48c-TCAD),
...
// 예: RND-CAE001-LICE48c-TCAD -> [RND, CAE001, LICE48c, TCAD]
const folderRecordCount = 4

// NormalizeFolderName은 폴더명을 스펙 비교용 형태로 정규화한다.
// 1·3·4번째 레코드는 그대로 두고, 2번째(차수) 레코드의 숫자만 떼어낸다.
// 예: RND-CAE001-LICE48c-TCAD, RND-CAE003-LICE48c-TCAD -> 둘 다 RND-CAE-LICE48c-TCAD
//
