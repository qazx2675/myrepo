...
cd myrepo
tar czf vm-param-check.tar.gz ".claude/VM 업무/vm-param-check-usability-improvement/vm-param-check"
```

### 빌드 (인터넷 여부와 무관 — vendor/ 포함되어 있음)
```bash
cd ".claude/VM 업무/vm-param-check-usability-improvement/vm-param-check"
bash setup.sh
```
