...
**이 폴더는 더 이상 권장되는 방식이 아닙니다.** 새로 시작하는 경우 대신 `../VM 매개변수 체크 및 설정 통합 툴 사용성 개선/VM 매개변수 체크 및 설정 통합 툴/`(자체 내장 `-fix`, 외부 도구 불필요)을 쓰세요. 자세한 대체 배경은 그 폴더의 README.md "기존 개별 도구와의 관계" 절 참고.
